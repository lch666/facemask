...
def inference(img_path,
    ...
    for path in paths:
        ...
        for idx in keep_idxs:
            ...
            with open('.//data//test.txt', 'a+') as f:
                f.write(' '.join([str(xmin), str(ymin), str(xmax - xmin), str(ymax - ymin), str(0), str(0), str(0), str(0), str(0) + '\n'])) 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img-path', type=str, default='./data/test_images', help='path to your image.')
    ...
    if args.img_mode:
        ...
        inference(imgPath, show_result=True, target_shape=(360, 360))
    else:
